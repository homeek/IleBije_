...
public class activity_srodek3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srodek3);
...
//tworzy array list
                        listaTowarow.add(new ElementyKalendarza(R.drawable.omcia, przekazywana + "", "  " + przekazywana_iloscml + "ml", "strzał nr. ", w + 1, date, dateTime));
...
//alarm notyfikacji z interwałem dziennym razy okres teraaz bez interwału, tylko wysyłła
                    ...
                    alarmManager.set(AlarmManager.RTC_WAKEUP, c.getTimeInMillis(), pendingIntent3);
        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listaTowarow.isEmpty()) {
                    ...
                    Intent doZmianyIntent = new Intent(getApplicationContext(), activity_srodek3_reload.class);
...
//klik do ilebije
    ...
    private void saveData() {
        ...
        editorr.putBoolean("bollBoottrzy", boolBoot);
        editorr.putString("keytrzy", przekazywana);
...
// przekazywanie daty dalej po to aby wstawiał date od pierwszego bicia
        ...
        editorr.putInt("pierwszeBicietrzy", dataDzien);
