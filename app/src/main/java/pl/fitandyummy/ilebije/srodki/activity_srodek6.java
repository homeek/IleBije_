...
public class activity_srodek6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srodek6);
...
//tworzy array list
                        listaTowarow.add(new ElementyKalendarza(R.drawable.fiolka2, przekazywana + "", "  " + przekazywana_iloscml + "ml", "strzał nr. ", w + 1, date, dateTime));
        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listaTowarow.isEmpty()) {
                    ...
                    Intent doZmianyIntent = new Intent(getApplicationContext(), activity_srodek6_reload.class);
...
//klik do ilebije
    ...
    private void saveData() {
        ...
        editorr.putBoolean("bollBootszesc", boolBoot);
        editorr.putString("keyszesc", przekazywana);
...
// przekazywanie daty dalej po to aby wstawiał date od pierwszego bicia
        ...
        editorr.putInt("pierwszeBicieczesc", dataDzien);
        editorr.apply();
