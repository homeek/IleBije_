...
import pl.fitandyummy.ilebije.broadcast.srodek_piec_Notyfication_reciver;

public class activity_srodek5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srodek5);
...
//tworzy array list
                        listaTowarow.add(new ElementyKalendarza(R.drawable.lotka2, przekazywana + "", "  " + przekazywana_iloscml + "ml", "strzał nr. ", w + 1, date, dateTime));
        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listaTowarow.isEmpty()) {
                    ...
                    Intent doZmianyIntent = new Intent(getApplicationContext(), activity_srodek5_reload.class);
...
//klik do ilebije
    ...
    private void saveData() {
        ...
        editorr.putString("keypiec", przekazywana);
...
// przekazywanie daty dalej po to aby wstawiał date od pierwszego bicia
        ...
        editorr.putInt("pierwszeBiciepiec", dataDzien);
