...
public class IleBijeMililitrow extends AppCompatActivity {

    TextView wynikml;

    int intmocarnosc;

    TextView txt1, txt2, txt3, txt4, txt5, mocarnoscTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ile_bije_mililitrow);
